...
Some instruments using different modes of access to the same entity give different results, but nonteheless provide valuable data (section 2.5, galaxies through different measurement modes).
