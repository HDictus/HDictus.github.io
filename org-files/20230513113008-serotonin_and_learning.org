...
This makes sense of the aforementioned result from He et al.
When something unexpected happens, the patterns of activity that led to the incorrect expectation should be disrupted.
One way to do this would be to weaken the connections that were the most influential.
