...
[[id:9801d89b-3de0-4d60-b2f8-b0d9b26957d0][One paper by Matias et al.]] shows that some of the neurons in the Dorsal Raphe Nucleus respond strongly both when things turn out worse than expected, and when things turn out better than expected. TODO: once I have internet again, double-check this is an accurate summary.
...
Nonetheless it is consistent with a variety of other experiments.
...
This originally motivated the idea that depression is a straightforward chemical imbalance, but further evidence for this theory is severly limited.
Additionally,  SSRIs sometimes take several weeks to reach their full effect in a depressed patient, which is not what would be expected in the event of a chemical imbalance.
...
As I've hinted already, there are some conflicting results that show the idea of serotonin as an 'un-learning' chemical is greatly simplistic.
 ...
 - The results around the 5HT2C receptor are confusing.
   Above we discussed how the experiment by He and colleagues showed that it is a natural candidate for explaining the un-learning effects of serotonin.
 ...
 - Serotonin seems to also somehow mediate other forms of learning signals, such as reward anticipation. 
