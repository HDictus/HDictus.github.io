...
* is it for asymmetric (armed-unarmed) contexts?
...
The importance of grabbing in karate may also explain why there is such a wealth of techniques aimed at breaking a grip on the wrist.
...
Many kung fu styles show a lot of the things that I attribute to clinching in karate and so may have a similar focus, but frankly I do not have much experience in kung fu, so I cannot say for sure.
...
This seems to me an attempt to rationalize a way of training, rather than evaluate it.
...
The way you are first taught techniques, and indeed the way you mostly practice technqiues as a novice, differs markedly from the way they are executed in competitions.
...
Many of them resemble the explanation Dan provided for the lunge punch, or explanations for why the basic blocks are such slow, large movements.
