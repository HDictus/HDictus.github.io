...
[[yt:CQdYtXsOYLs?si=grU4uLa4emIlfXpz&t=9]]
...
This blog [[https://www.wayofleastresistance.net/2013/02/lunge-punches-why-bother.html][post]] by Dan Djurdevic concurs that step-through lunge punches are never seen in karate competition, because they leave you too vulnerable.
If you step through to chase an opponent, you do not punch with the lead hand but with the rear, and use the pushing motion to propel your step forward (like [[https://youtu.be/6zOR34e8LDU?si=EQ0qerktSQR6xfvi&t=273][this]]).
...
One interesting perspective on this comes from the channel [[https://youtu.be/aA5KerxdwCQ?si=nqVWZtulf47Bz20a&t=212][Hein's approach to aikido]].
...
Getting an opponent to over-commit to a forward movement by backing away from them is a powerful tactic in competitive fighting - despite the fact that backing away is heavily penalized.
When backing away is a good in itself it is of course a stronger strategy still.

This may explain defenses against lunge punches, but could it also explain the lunge punches themselves?
For karate, maybe.
Karate forms, at least those in shotokan, are full of big gap-closers.n
I think there is very good evidence that traditional karate was, unlike modern competitive karate, a heavily clinch-focused style built around grabbing someone before you hit them.

The kicks present in the shotokan kata I learned are only ever gap closers followed by some sort of pulling motion and strike.
...
Additionally, since this is true also for symmetric sword arts focused on dueling, like italian longsword, challenges the idea above, that it comes from an asymmetric need to close the distance.


A different explanation for why these techniques are studied is offered by Dan Djurevic, who I referred to above.
...
I can find no evidence that it is true, besides the presence of movements that don't make sense in karate.
...
To me, this is a clear attempt to rationalize a way of training rather than explain it.
...
But as the Cho brothers pointed out, experienced competitiors only do a little bit of traditional training as a warm-up, and spend the bulk of their training working competitive variations.
...
Judo's reputation for a harsh learning curve is well earned, but it may mostly be due to this one issue.
