...
Additionally, since this is true also for symmetric sword arts focused on dueling, like italian longsword, this fact challenges the idea presented by Hein, that lunging comes from an asymmetric need to close the distance.
...
Since the release of a video by Cho Junho and Cho Junhyun, it is finally being taken seriously by more experienced practitioners.
